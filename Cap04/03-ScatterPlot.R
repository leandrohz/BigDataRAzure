...
# Define os dados
set.seed(67) #para outro cientista de dados ver os mesmos dados do teste realizado;
#funções para criação de distribuição de probabilidade;
x = rnorm(10,5,7)
y = rpois(10,7)
z = rnorm(10,6,7)
t = rpois(10,9)

?plot #gráfico estatístico
# Cria o Plot
#gráfico de disperção (scaterplot) mostra a relação entre duas (ou mais) variáveis;
